...
async function main() {
  ...
  await db.businessTag.deleteMany();
  await db.businessFood.deleteMany();
  await db.business.deleteMany();
  await db.foodImage.deleteMany();
  await db.foodTag.deleteMany();
  ...
  const chefMario = await db.user.create({
    data: {
      userName: "chef_mario",
  ...
  const adobo = await db.food.create({
    data: {
      name: "Adobo",
      description:
  ...
  const sinigang = await db.food.create({
    data: {
      name: "Sinigang",
  ...
  const haloHalo = await db.food.create({
    data: {
      name: "Halo-Halo",
      description:
  ...
  const pancitPalabok = await db.food.create({
    data: {
      name: "Pancit Palabok",
      description:
  ...
  const lechon = await db.food.create({
    data: {
      name: "Lechon",
      description:
