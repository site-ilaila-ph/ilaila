  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="mx-auto flex min-h-screen max-w-[1600px] gap-5 p-4 lg:p-6">
        <aside className="hidden w-56 shrink-0 flex-col rounded-2xl bg-card px-3 py-5 shadow-sm border border-border lg:flex">
          <div className="flex items-center gap-2 px-3 pb-7 text-sm font-bold text-foreground">
          ...
          <div className="mt-auto rounded-xl bg-primary p-3 text-xs text-primary-foreground shadow-sm">
            <p className="font-semibold">Kailangan ng tulong?</p>
            <p className="mt-1 text-primary-foreground/80">Tingnan ang dokumentasyon</p>
          </div>
        </aside>
        <main className="min-w-0 px-4 flex-1">{children}</main>
      </div>
    </div>
  );
}
