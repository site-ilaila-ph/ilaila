...
function Button<TAs extends React.ElementType = "button">({
  className,
  variant = "default",
  size = "default",
  as,
  render,
  ...props
}: PolymorphicComponentProps<VariantProps<typeof buttonVariants>, TAs>) {
  throwIfUsingRenderProp({ render })
  const Component = as ?? ButtonPrimitive
