...
import { throwIfUsingRenderProp, type PolymorphicComponentProps } from "@/lib/client/components/component-polymorphism"
...
function Badge<TAs extends React.ElementType = "span">({
  className,
  variant = "default",
  as,
  render,
  ...props
}: PolymorphicComponentProps<VariantProps<typeof badgeVariants>, TAs>) {
